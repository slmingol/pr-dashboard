...
A containerized pull request dashboard that integrates with your `ghreport` CLI tool and GitHub CLI to provide a comprehensive view of all your PRs with review tracking and management features.
