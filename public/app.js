      ...
      showModal(`
        <div class="diff-header-bar">
          <div class="diff-header-left">
            ...
            ${prData?.author?.login ? (
              teamMembers.has(prData.author.login.toLowerCase())
                ? `<span class="author-team-badge diff-header-author" title="Bandwidth PaaS team member">&#9733; ${escapeHtml(prData.author.login)}</span>`
                : `<span class="diff-header-author" title="PR author">by ${escapeHtml(prData.author.login)}</span>`
            ) : ''}
